...
//             <a href="/sign-up" className="text-emerald-600 font-semibold hover:underline">
//               Sign up here
//             </a>
//           </p>
//         </motion.div>
...
const Login = () => {
  ...
  const handleLogin = async (e) => {
    ...
    setLoading(true);
    try {
      console.log("Sending login request with:", formData); // Debug request
      const response = await axiosPublic.post("/login/", formData);
      const { access, refresh, user: userData } = response.data;
      console.log("Login response:", { access, refresh, userData }); // Debug response
      ...
      setTimeout(() => navigate("/tuition-form"), 2000);
    } catch (error) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-emerald-50/90 pt-20 pb-12">
      <motion.div
      ...
      >
        <h1 className="text-3xl font-bold text-center text-emerald-600 mb-8">Login</h1>
        ...
        <form onSubmit={handleLogin} className="space-y-6">
          ...
          <motion.button
            type="submit"
            className="w-full py-3 bg-emerald-500 text-white rounded-lg font-semibold hover:bg-emerald-600 transition-all"
